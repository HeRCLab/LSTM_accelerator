...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a20struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.53"([20 x i22]* align 512 %3, [20 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %2)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a3280struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.64"([3280 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %0, [3280 x i22]* %1)
  ...
  call fastcc void @"onebyonecpy_hls.p0a80struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.43"([80 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %4, [80 x i22]* align 512 %5)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a80struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.43"([80 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* noalias "unpacked"="0" %dst, [80 x i22]* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [80 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a80struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.46"([80 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* nonnull %dst, [80 x i22]* %src, i64 80)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a80struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.46"([80 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* "unpacked"="0" %dst, [80 x i22]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [80 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a20struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.53"([20 x i22]* noalias nocapture align 512 "unpacked"="0.0" %dst, [20 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [20 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a20struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.56"([20 x i22]* %dst, [20 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* nonnull %src, i64 20)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a20struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.56"([20 x i22]* nocapture "unpacked"="0.0" %dst, [20 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [20 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a3280struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.64"([3280 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* noalias "unpacked"="0" %dst, [3280 x i22]* noalias nocapture readonly "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [3280 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a3280struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.67"([3280 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* nonnull %dst, [3280 x i22]* %src, i64 3280)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a3280struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>.67"([3280 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* "unpacked"="0" %dst, [3280 x i22]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [3280 x %"struct.ap_ufixed<22, 5, AP_RND, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
