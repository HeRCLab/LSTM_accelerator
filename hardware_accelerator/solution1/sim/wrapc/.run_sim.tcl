...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "network_top.autotvin.dat"
	set constFileTvOut       "network_top.autotvout.dat"
	set constFileHdlTvIn     "network_top.autohdltvin.dat"
	set constFileHdlTvOut    "network_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
