    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_MYPARAMS_DATA_0: begin
                    rdata <= int_myparams[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MYPARAMS_DATA_0)
            int_myparams[31:0] <= (WDATA[31:0] & wmask) | (int_myparams[31:0] & ~wmask);
    end
end
