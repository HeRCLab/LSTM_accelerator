...
end entity network_top_control_s_axi;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MYPARAMS_DATA_0) then
                    int_myparams(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_myparams(31 downto 0));
                end if;
            end if;
        end if;
    end process;
